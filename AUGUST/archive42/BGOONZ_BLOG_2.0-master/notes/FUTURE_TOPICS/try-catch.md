...
<figure><img src="article/try-catch/try-catch-flow.svg" width="514" height="411" /></figure>So, an error inside the `try {...}` block does not kill the script – we have a chance to handle it in `catch`.
...
## <a href="try-catch.html#using-try-catch" id="using-try-catch" class="main__anchor">Using “try…catch”</a>
